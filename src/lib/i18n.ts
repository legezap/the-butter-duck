...
const translations = {
  en: {
    ...
    // Defence page
    "nav.defence": "Defence",
    "defencepage.hero.label": "Defence & Aerospace",
    "defencepage.title": "Your Stand at",
    "defencepage.title.accent": "IDEX.",
    "defencepage.title.suffix": "Built in Abu Dhabi.",
    "defencepage.hero.desc": "Turnkey exhibition stand design, construction, and delivery for the world's leading defence and aerospace exhibitions. Local production near ADNEC \u2014 zero international shipping, zero customs delays, and faster build times.",
    "defencepage.cta.proposal": "Request a Proposal",
    "defencepage.cta.why": "Why Local Production?",
    "defencepage.events.label": "Events We Cover",
    "defencepage.events.title": "The World\u2019s Leading",
    "defencepage.events.accent": "Defence Exhibitions",
    "defencepage.events.desc": "We build exhibition stands for exhibitors at Tier 1 and Tier 2 defence, aerospace, and security exhibitions across the GCC and Asia-Pacific.",
    "defencepage.events.idex": "IDEX / NAVDEX 2027",
    "defencepage.events.idex.desc": "Abu Dhabi, UAE. The world\u2019s largest joint defence exhibition. 1,400+ exhibitors, 65,000+ visitors. Our home turf \u2014 local production, direct venue access.",
    "defencepage.events.idex.loc": "Abu Dhabi, Feb 2027",
    "defencepage.events.wds": "World Defense Show",
    "defencepage.events.wds.desc": "Riyadh, Saudi Arabia. Saudi Arabia\u2019s flagship defence event. Rapid growth, government-backed, massive pavilion opportunities.",
    "defencepage.events.wds.loc": "Riyadh, Feb 2026",
    "defencepage.events.singapore": "Singapore Airshow",
    "defencepage.events.singapore.desc": "Changi Exhibition Centre. Asia\u2019s largest aerospace and defence exhibition. 1,000+ exhibitors. Key market for APAC expansion.",
    "defencepage.events.singapore.loc": "Singapore, Feb 2026",
    "defencepage.events.dsa": "DSA Malaysia",
    "defencepage.events.dsa.desc": "Defence Services Asia. Southeast Asia\u2019s premier defence exhibition. Growing market, strong demand for turnkey stand solutions.",
    "defencepage.events.dsa.loc": "Kuala Lumpur, 2026",
    "defencepage.events.indo": "Indo Defence",
    "defencepage.events.indo.desc": "Jakarta, Indonesia. Indonesia\u2019s tri-service defence exhibition. Expanding regional presence with high exhibitor demand.",
    "defencepage.events.indo.loc": "Jakarta, Nov 2026",
    "defencepage.events.others": "AAD / EDEX / ADEX",
    "defencepage.events.others.desc": "Africa Aerospace & Defence, Egypt Defence Expo, Azerbaijan Defence Exhibition. Tier 2 events with strong commercial potential.",
    "defencepage.events.others.loc": "Regional Coverage",
    "defencepage.local.label": "Local Advantage",
    "defencepage.local.title": "Built Near",
    "defencepage.local.accent": "ADNEC.",
    "defencepage.local.suffix": "Not Shipped From Europe.",
    "defencepage.local.p1": "Most exhibition companies ship stands internationally \u2014 adding 4\u20136 weeks of lead time, customs clearance headaches, and 15\u201325% in logistics costs. We produce locally in the UAE.",
    "defencepage.local.p2": "Our production facility is near Abu Dhabi National Exhibitions Centre (ADNEC), the venue for IDEX/NAVDEX. This means your stand goes from our workshop to the exhibition floor in hours, not weeks.",
    "defencepage.local.b1": "Zero international shipping costs",
    "defencepage.local.b2": "No customs clearance delays",
    "defencepage.local.b3": "Faster build and installation timeline",
    "defencepage.local.b4": "Direct venue coordination with ADNEC",
    "defencepage.local.b5": "On-site adjustments during build-up",
    "defencepage.local.b6": "Post-event storage and stand reuse options",
    "defencepage.stands.label": "Stand Types",
    "defencepage.stands.title": "From Product Showcases to",
    "defencepage.stands.accent": "National Pavilions",
    "defencepage.stands.desc": "Whether you need a focused 20 sqm product demo space or a 500+ sqm double-decker pavilion with meeting rooms, AV integration, and VIP hospitality \u2014 we design and build it all.",
    "defencepage.stands.turnkey": "Turnkey Exhibition Stand",
    "defencepage.stands.turnkey.desc": "Complete design-to-delivery solution. 3D visualization, structural engineering, fabrication, graphics, AV, installation, and dismantling. 20\u2013200 sqm.",
    "defencepage.stands.double": "Double-Decker Pavilion",
    "defencepage.stands.double.desc": "Two-story structures with meeting rooms, hospitality areas, and rooftop terraces. Engineered for safety compliance. 100\u2013700 sqm.",
    "defencepage.stands.upgrade": "Space Only Upgrade",
    "defencepage.stands.upgrade.desc": "Already have raw exhibition space? We transform it with custom walls, flooring, lighting, graphics, and furniture. Cost-effective for tight budgets.",
    "defencepage.stands.display": "Product Display Integration",
    "defencepage.stands.display.desc": "Specialized mounting, lighting, and security for defence hardware displays. Vehicles, UAVs, weapon systems, and technology demonstrations.",
    "defencepage.process.label": "Our Process",
    "defencepage.process.title": "From Brief to",
    "defencepage.process.accent": "Build-Up",
    "defencepage.process.desc": "A proven process refined across 80+ projects. Every step is managed by senior team members \u2014 no handoffs to junior staff after the sale.",
    "defencepage.process.s1": "Discovery & Brief",
    "defencepage.process.s1.desc": "We learn your objectives, brand guidelines, product showcase requirements, meeting room needs, and VIP hosting expectations. You receive 3 concept directions within 7 days.",
    "defencepage.process.s2": "Design & Engineering",
    "defencepage.process.s2.desc": "Photorealistic 3D renders, structural calculations, AV integration plans, and detailed material specifications. Full design package for your review and approval.",
    "defencepage.process.s3": "Production",
    "defencepage.process.s3.desc": "In-house fabrication management with our UAE workshop partners. Weekly progress photos. Materials sourced locally \u2014 no international supply chain risks.",
    "defencepage.process.s4": "Installation",
    "defencepage.process.s4.desc": "Our crew handles delivery, build-up, AV testing, graphics installation, and final walkthrough. We stay on-site until you sign off.",
    "defencepage.process.s5": "Show Support & Dismantling",
    "defencepage.process.s5.desc": "On-call technical support during the exhibition. Professional dismantling and cleanup. Storage options for stand reuse at future events.",
    "defencepage.agency.label": "For Agencies",
    "defencepage.agency.title": "Your Vision.",
    "defencepage.agency.accent": "Our Execution.",
    "defencepage.agency.p1": "Working with an agency like Jack Morton, George P. Johnson, or a regional creative house? We operate as your local production partner in the UAE and GCC.",
    "defencepage.agency.p2": "We work under your brand, follow your design specifications, and deliver to your quality standards. Your client sees a seamless experience. You get a reliable executor who knows the local venues, regulations, and suppliers.",
    "defencepage.agency.b1": "White-label production capability",
    "defencepage.agency.b2": "ADNEC and DWTC venue expertise",
    "defencepage.agency.b3": "Structural engineering and safety compliance",
    "defencepage.agency.b4": "Full project documentation and reporting",
    "defencepage.agency.b5": "After-show service and maintenance contracts",
    "defencepage.cta.title": "Exhibiting at IDEX 2027?",
    "defencepage.cta.desc": "Outreach for IDEX 2027 starts June 2026. Get ahead of the queue \u2014 submit your brief now and receive 3 complimentary design concepts within 7 days.",
    "defencepage.cta.download": "Download Capability Statement",
  ...
  ar: {
    ...
    "mega.concept.desc": "بيئات تفاعلية تعكس هوية علامتك",
    ...
    "hero.sub": "أجنحة معارض، إنتاج فعاليات، وبيئات تفاعلية للعلامات التجارية من <strong>25 م² إلى 1000+ م²</strong>. موثوقون من Microsoft وVanderlande وعلامات تجارية في 10 دول.",
    ...
    "servicespage.media.b6": "فيديوهات ملخصة للفعاليات ودراسات حالة بعد المعرض",
    ...
    "process.step2.desc": "تصاميم ثلاثية الأبعاد ومواصفات المواد والرسومات الفنية — نعيد ونكرر حتى تكون النتيجة مبهرة.",
    ...
    "about.p1": "شركة معارض وفعاليات مقرها الإمارات تعمل كوحدة عمليات خاصة: فريق مركّز، لا يساوم على المواعيد.",
    "about.p2": "فريقنا يجمع التصميم المعماري والهندسة الإنشائية والإنتاج الإبداعي تحت سقف واحد — بلا وسطاء.",
    ...
    "aboutpage.values.title.alt": "ما نؤمن",
    "aboutpage.values.title.accent.alt": "به",
    ...
    "aboutpage.values.v6.desc": "مقرنا الإمارات، ننفّذ في 10 دول. نعرف المواقع والموردين واللوائح.",

    // About page — capabilities
    "aboutpage.cap.label": "القدرات",
    "aboutpage.cap.title": "ما نضعه",
    ...
    "contact.desc": "املأ نموذج ملخص المشروع أدناه وسنرد بعرض مفصّل خلال 24 ساعة. كل استفسار يحظى باهتمام الإدارة العليا.",
    ...
    "contact.direct.desc": "تفضّل محادثة سريعة؟ تواصل مباشرة عبر الهاتف أو البريد أو واتساب. فريقنا متاح من الأحد إلى الخميس، 9:00 صباحاً – 6:00 مساءً بتوقيت الخليج.",
    ...
    "contact.budget.discuss": "نتفق عليها لاحقاً",
    ...
    // Defence page
    "nav.defence": "الدفاع",
    "defencepage.hero.label": "الدفاع والفضاء",
    "defencepage.title": "جناحك في",
    "defencepage.title.accent": "آيدكس.",
    "defencepage.title.suffix": "مبني في أبوظبي.",
    "defencepage.hero.desc": "تصميم وبناء أجنحة المعارض الجاهزة لأبرز معارض الدفاع والفضاء في العالم. إنتاج محلي بالقرب من أدنيك — بدون شحن دولي، بدون تأخيرات جمركية، وبأوقات بناء أسرع.",
    "defencepage.cta.proposal": "طلب عرض سعر",
    "defencepage.cta.why": "لماذا الإنتاج المحلي؟",
    "defencepage.events.label": "المعارض التي نغطيها",
    "defencepage.events.title": "المعارض الدفاعية",
    "defencepage.events.accent": "الرائدة عالمياً",
    "defencepage.events.desc": "نبني أجنحة المعارض للعارضين في معارض الدفاع والفضاء والأمن من المستوى الأول والثاني عبر دول الخليج وآسيا والمحيط الهادئ.",
    "defencepage.events.idex": "آيدكس / نافدكس 2027",
    "defencepage.events.idex.desc": "أبوظبي، الإمارات. أكبر معرض دفاعي مشترك في العالم. أكثر من 1,400 عارض و65,000 زائر. أرضنا — إنتاج محلي، وصول مباشر للمكان.",
    "defencepage.events.idex.loc": "أبوظبي، فبراير 2027",
    "defencepage.events.wds": "معرض الدفاع العالمي",
    "defencepage.events.wds.desc": "الرياض، المملكة العربية السعودية. الحدث الدفاعي الرائد في السعودية. نمو سريع، دعم حكومي، فرص أجنحة ضخمة.",
    "defencepage.events.wds.loc": "الرياض، فبراير 2026",
    "defencepage.events.singapore": "معرض سنغافورة للطيران",
    "defencepage.events.singapore.desc": "مركز تشانغي للمعارض. أكبر معرض للفضاء والدفاع في آسيا. أكثر من 1,000 عارض. سوق رئيسي للتوسع في آسيا.",
    "defencepage.events.singapore.loc": "سنغافورة، فبراير 2026",
    "defencepage.events.dsa": "DSA ماليزيا",
    "defencepage.events.dsa.desc": "خدمات الدفاع آسيا. المعرض الدفاعي الأول في جنوب شرق آسيا. سوق متنامٍ وطلب قوي على حلول الأجنحة الجاهزة.",
    "defencepage.events.dsa.loc": "كوالالمبور، 2026",
    "defencepage.events.indo": "إندو ديفنس",
    "defencepage.events.indo.desc": "جاكرتا، إندونيسيا. معرض الدفاع ثلاثي الأسلحة في إندونيسيا. حضور إقليمي متزايد مع طلب مرتفع من العارضين.",
    "defencepage.events.indo.loc": "جاكرتا، نوفمبر 2026",
    "defencepage.events.others": "AAD / EDEX / ADEX",
    "defencepage.events.others.desc": "معرض أفريقيا للفضاء والدفاع، معرض مصر للدفاع، معرض أذربيجان للدفاع. معارض من المستوى الثاني بإمكانيات تجارية قوية.",
    "defencepage.events.others.loc": "تغطية إقليمية",
    "defencepage.local.label": "الميزة المحلية",
    "defencepage.local.title": "مبني بالقرب من",
    "defencepage.local.accent": "أدنيك.",
    "defencepage.local.suffix": "ليس مشحوناً من أوروبا.",
    "defencepage.local.p1": "معظم شركات المعارض تشحن الأجنحة دولياً — مما يضيف 4-6 أسابيع من وقت التسليم، ومتاعب التخليص الجمركي، و15-25% تكاليف لوجستية. نحن ننتج محلياً في الإمارات.",
    "defencepage.local.p2": "مرافق إنتاجنا بالقرب من مركز أبوظبي الوطني للمعارض (أدنيك)، مكان إقامة آيدكس/نافدكس. هذا يعني أن جناحك ينتقل من ورشتنا إلى أرض المعرض في ساعات، وليس أسابيع.",
    "defencepage.local.b1": "صفر تكاليف شحن دولية",
    "defencepage.local.b2": "بدون تأخيرات تخليص جمركي",
    "defencepage.local.b3": "جداول بناء وتركيب أسرع",
    "defencepage.local.b4": "تنسيق مباشر مع أدنيك",
    "defencepage.local.b5": "تعديلات في الموقع أثناء البناء",
    "defencepage.local.b6": "خيارات تخزين وإعادة استخدام الجناح بعد المعرض",
    "defencepage.stands.label": "أنواع الأجنحة",
    "defencepage.stands.title": "من عروض المنتجات إلى",
    "defencepage.stands.accent": "الأجنحة الوطنية",
    "defencepage.stands.desc": "سواء كنت بحاجة إلى مساحة عرض منتجات من 20 م² أو جناح من طابقين بمساحة 500+ م² مع غرف اجتماعات وتكامل سمعي بصري وضيافة VIP — نصمم ونبني كل شيء.",
    "defencepage.stands.turnkey": "جناح معرض جاهز",
    "defencepage.stands.turnkey.desc": "حل متكامل من التصميم إلى التسليم. تصور ثلاثي الأبعاد، هندسة إنشائية، تصنيع، رسومات، سمعي بصري، تركيب، وتفكيك. 20-200 م².",
    "defencepage.stands.double": "جناح من طابقين",
    "defencepage.stands.double.desc": "هياكل من طابقين مع غرف اجتماعات ومناطق ضيافة وشرفات سطحية. مصمم هندسياً وفق معايير السلامة. 100-700 م².",
    "defencepage.stands.upgrade": "ترقية المساحة الفارغة",
    "defencepage.stands.upgrade.desc": "لديك مساحة معرض خام؟ نحولها بجدران مخصصة، أرضيات، إضاءة، رسومات، وأثاث. فعال من حيث التكلفة للميزانيات المحدودة.",
    "defencepage.stands.display": "تكامل عرض المنتجات",
    "defencepage.stands.display.desc": "تركيب متخصص وإضاءة وأمان لعروض المعدات الدفاعية. مركبات، طائرات بدون طيار، أنظمة أسلحة، وعروض تقنية.",
    "defencepage.process.label": "عمليتنا",
    "defencepage.process.title": "من الموجز إلى",
    "defencepage.process.accent": "البناء",
    "defencepage.process.desc": "عملية مثبتة تم صقلها عبر أكثر من 80 مشروعاً. كل خطوة يديرها أعضاء فريق كبار — بدون تسليم لموظفين مبتدئين بعد البيع.",
    "defencepage.process.s1": "الاكتشاف والموجز",
    "defencepage.process.s1.desc": "نتعرف على أهدافك وإرشادات علامتك التجارية ومتطلبات عرض المنتجات واحتياجات غرف الاجتماعات وتوقعات استضافة كبار الشخصيات. تحصل على 3 اتجاهات تصميم خلال 7 أيام.",
    "defencepage.process.s2": "التصميم والهندسة",
    "defencepage.process.s2.desc": "عروض ثلاثية الأبعاد واقعية، حسابات إنشائية، خطط تكامل سمعي بصري، ومواصفات مواد مفصلة. حزمة تصميم كاملة لمراجعتك وموافقتك.",
    "defencepage.process.s3": "الإنتاج",
    "defencepage.process.s3.desc": "إدارة تصنيع داخلية مع شركائنا في ورش الإمارات. صور تقدم أسبوعية. مواد محلية المصدر — بدون مخاطر سلسلة إمداد دولية.",
    "defencepage.process.s4": "التركيب",
    "defencepage.process.s4.desc": "فريقنا يتولى التوصيل والبناء واختبار الأنظمة السمعية البصرية وتركيب الرسومات والجولة النهائية. نبقى في الموقع حتى توافق.",
    "defencepage.process.s5": "دعم المعرض والتفكيك",
    "defencepage.process.s5.desc": "دعم فني أثناء المعرض. تفكيك وتنظيف احترافي. خيارات تخزين لإعادة استخدام الجناح في فعاليات مستقبلية.",
    "defencepage.agency.label": "للوكالات",
    "defencepage.agency.title": "رؤيتكم.",
    "defencepage.agency.accent": "تنفيذنا.",
    "defencepage.agency.p1": "تعمل مع وكالة مثل جاك مورتون أو جورج بي جونسون أو شركة إبداعية إقليمية؟ نعمل كشريك إنتاج محلي في الإمارات ودول الخليج.",
    "defencepage.agency.p2": "نعمل تحت علامتك التجارية، نتبع مواصفات تصميمك، ونسلم وفق معايير جودتك. عميلك يرى تجربة سلسة. أنت تحصل على منفذ موثوق يعرف الأماكن المحلية واللوائح والموردين.",
    "defencepage.agency.b1": "إمكانية إنتاج بالعلامة البيضاء",
    "defencepage.agency.b2": "خبرة بأماكن أدنيك ومركز دبي التجاري العالمي",
    "defencepage.agency.b3": "هندسة إنشائية وامتثال للسلامة",
    "defencepage.agency.b4": "توثيق مشروع كامل وتقارير",
    "defencepage.agency.b5": "خدمة ما بعد المعرض وعقود صيانة",
    "defencepage.cta.title": "تعرض في آيدكس 2027؟",
    "defencepage.cta.desc": "يبدأ التواصل لآيدكس 2027 في يونيو 2026. كن سباقاً — قدم موجزك الآن واحصل على 3 تصاميم مجانية خلال 7 أيام.",
    "defencepage.cta.download": "تحميل بيان القدرات",
