...
const translations = {
  en: {
    ...
    "testimonials.2.company": "Industrial Automation Leader",
    ...
    "testimonials.3.company": "Regional Logistics Provider",
    ...
    "aboutpage.tl.2022.title": "Major Tech Partnership",
    "aboutpage.tl.2022.desc": "Selected as exhibition partner for a global tech leader's regional event activations.",
  ...
  ar: {
    ...
    // Cinematic dividers (homepage)
    "cine.microsoft": "700 م². طابقين. أكبر مشاريعنا في LEAP.",
